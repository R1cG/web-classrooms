...
import { evaluacionesStore } from '@/routes';
import { useForm } from '@inertiajs/react';
import { useState, useEffect } from 'react';
import { Save, ArrowLeft, AlertCircle, CalendarDays, FileText, ClipboardList, Clock, ChevronLeft } from 'lucide-react';

interface Props {
    aulaId: number;
}

export default function EvaluacionCreate({ aulaId }: Props) {
        ...
        <AppLayout>
            ...
            <div className="ev-root min-h-screen bg-slate-50 p-4 md:p-8">
                <div className="max-w-2xl mx-auto">
                    ...
                    >
                        <div className="relative z-10 px-6 py-5">
                            ...
                            <p className="text-slate-400 text-xs mt-3 pt-3" style={{ borderTop: '1px solid rgba(255,255,255,0.07)' }}>
                                Programa y describe tu próxima evaluación · visible para todos los miembros del aula
                            </p>
                        </div>
                    </div>
                    ...
                    >
                        Las evaluaciones ayudan a mantener organizadas las entregas del aula
                    </p>
                </div>
            </div>
        </AppLayout>
